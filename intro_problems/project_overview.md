...
- Review Python skills for the course.
...
Download and open the zipped folder here(opens in a new tab). In the folder you will find five python files Task0.py, Task1.py, ...,Task4.py and two csv files calls.csv and texts.csv
...
How to use the above methods - https://docs.python.org/3/howto/sorting.html(opens in a new tab)
Complexity analysis of Timsort and Samplesort - http://svn.python.org/projects/python/trunk/Objects/listsort.txt(opens in a new tab)
